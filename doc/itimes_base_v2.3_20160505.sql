...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'iyihua', '0', '457ebd4372bbb8f58881e3aabb254ade16296f0deba1853f', '1', '', null, '123456789', '0', null, '0000-00-00 00:00:00', null, '0');
...
CREATE TABLE `user_config` (
  `user_config_id` bigint(20) NOT NULL,
  `detail` longtext,
